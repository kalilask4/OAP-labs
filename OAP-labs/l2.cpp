...
*	Задание 4																	*
*	Составить программу для определения значения функции.						*
*	Считать, что  при вычислении функции нахождение минимального 				*
*	и максимального элементов производится только среди различных значений.		*
*	В противном случае предусмотреть повторный ввод исходных данных. 			*
*	Самостоятельно определить исключительные ситуации и предусмотреть 			*
*	диагностические сообщения, если нормальное завершение программы невозможно 	*
*	(например, деление на ноль).												*
*	Вариант 6.																	*
*	s=(min⁡(max⁡(x,y),max⁡(y,z)))/(max⁡(y,z))										*
*																				*
*	Задание 5.																	*
*	Составить программу для вычисления составной функции.  						*
*	Самостоя-тельно выбрать необходимое количество исходных данных. 			*
*	Представить результаты работы, демонстрируя выполнение 						*
*	всех возможных ветвей алгоритма. Перед выводом полученного результата 		*
*	программа должна сообщать о ветви, при  прохождении которой он получен 		*
*	или сообщить о том, что решения не существует.								*
*	t2 =(sin)^2⁡(πn1+e^n2), если π≤n1+n2<5;										*
*	t2 = (sin)^2⁡(πn2+n1), если n1+n2≥5;										    *
*																				*
********************************************************************************/
